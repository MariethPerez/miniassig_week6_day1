...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { fecha_nac: @actor.fecha_nac, name: @actor.name, name_real: @actor.name_real } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { fecha_nac: @actor.fecha_nac, name: @actor.name, name_real: @actor.name_real } }
