...
class AlquilersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alquiler" do
    assert_difference('Alquiler.count') do
      post alquilers_url, params: { alquiler: { cassete_id: @alquiler.cassete_id, fecha_alquiler: @alquiler.fecha_alquiler, fecha_devolucion: @alquiler.fecha_devolucion, miembro_id: @alquiler.miembro_id } }
    end
  ...
  test "should update alquiler" do
    patch alquiler_url(@alquiler), params: { alquiler: { cassete_id: @alquiler.cassete_id, fecha_alquiler: @alquiler.fecha_alquiler, fecha_devolucion: @alquiler.fecha_devolucion, miembro_id: @alquiler.miembro_id } }
